...
model = dict(
    ...
    backbone=dict(
        ...
        clip_pretrained= None, # Changed from True to None
        init_cfg=dict(
            type='Pretrained',
            checkpoint=  # noqa: E251
            "C:\\Users\\rodol\\.cache\\torch\\hub\\checkpoints\\uniformerv2-base-p16-res224_clip-pre_u8_kinetics710-rgb_20221219-77d34f81.pth",  # noqa: E501
            prefix='backbone.')),
    cls_head=dict(
        type='UniFormerHead',
        dropout_ratio=0.5,
        num_classes=2, # Changed from 400 to 2 for non_salsa_basic and salsa_basic classes
        in_channels=768,
        average_clips='prob',
        channel_map=  # noqa: E251
        'C:\\Users\\rodol\\mmaction2\\configs\\recognition\\uniformerv2\\k710_channel_map\\map_k400.json',
        init_cfg=dict(
            type='Pretrained',
            checkpoint=  # noqa: E251
